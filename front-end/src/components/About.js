  ...
  return (
    <div className="About">
      ...
      <div className="about-text">
        ...
        <p>
        We understand, because we're all customers too.  We've all experienced the frustration of a clunky support process, and the joy of a seamless resolution.  [Your Tool Name] empowers businesses to deliver that joy consistently, making life a little bit better for everyone involved.
        </p>
      </div>
